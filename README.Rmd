...
BBNI's MCMC sampler was significantly optimized after the initial CRAN release. On a benchmark 5000-iteration run (the vignette simulation): **62.75 minutes -> 4.48 minutes (92.9% less time)**, with identical numerical output.
