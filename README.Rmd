...
BBNI's MCMC sampler was significantly optimized after the initial CRAN release. Controlled benchmarks show roughly an 10-fold speedup for 20-node networks; exact runtimes depend on hardware and system load.
