...
#> Sampler completed 5000 iterations ( 1e+05 node updates) in 2.41 minutes
```
...
#> Sampler completed 10000 iterations ( 140000 node updates) in 2.08 minutes
```
...
#>  [1] vctrs_0.7.3       cli_3.6.6         knitr_1.51        rlang_1.3.0       xfun_0.60         otel_0.2.0        purrr_1.2.2       pkgload_1.5.3     glue_1.8.1        rprojroot_2.1.1   pkgbuild_1.4.8   
#> [12] brio_1.1.5        evaluate_1.0.5    ellipsis_0.3.3    fastmap_1.2.0     lifecycle_1.0.5   memoise_2.0.1     compiler_4.6.0    igraph_2.3.3      fs_2.1.0          sessioninfo_1.2.4 pkgconfig_2.0.3  
#> [23] rstudioapi_0.18.0 R6_2.6.1          usethis_3.2.1     magrittr_2.0.5    tools_4.6.0       devtools_2.5.2    cachem_1.1.0      desc_1.4.3
```
