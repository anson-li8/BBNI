...
#' This maps each parent set \eqn{W(g_i)}{W(g_i)} to its corresponding valid Boolean transition
#' rule (e.g., \eqn{f_i(a)}{f_i(a)} can be \eqn{a}{a} or \eqn{\overline{a}}{\bar{a}}).
#'
